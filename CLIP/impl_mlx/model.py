...
class CLIPTextModel(nn.Module):
    """ Implements the text encoder transformer """
...
class CLIPVisionModel(nn.Module):
    """implements the vision encoder trainsformer from CLIP"""
...
class CLIPModel(nn.Module):
    ...
    def __call__(
        ...
        if return_loss and (input_ids is None or pixel_values is None):
            raise ValueError("Must proivide text and image inputs to compute loss")
